...
describe('getPlayerScores', () => {
  it('calculates the points for the HAVEN card', () => {
    const state = createState({
      tableau: ['GLASSWORKS', 'LUMBER_YARD', 'SAWMILL', 'HAVEN'],
    });
  ...
  it('calculates the points for the LIGHTHOUSE card', () => {
    const state = createState({
      tableau: ['STOCKADE', 'TAVERN', 'LIGHTHOUSE', 'MARKETPLACE'],
    });
    expect(getPlayerScores(state)).toEqual({
      winner: 'TEMPLE_OF_ARTEMIS_IN_EPHESUS',
      playerScores: [
  ...
  it('calculates the points for the CHAMBER_OF_COMMERCE card', () => {
    const state = createState({
      tableau: ['CHAMBER_OF_COMMERCE', 'TAVERN', 'GLASSWORKS', 'LOOM'],
    });
    expect(getPlayerScores(state)).toEqual({
      winner: 'TEMPLE_OF_ARTEMIS_IN_EPHESUS',
      playerScores: [
  ...
  it('calculates the points for the ARENA card', () => {
    const state = createState({
      tableau: ['STOCKADE', 'TAVERN', 'GLASSWORKS', 'ARENA'],
    });
    expect(getPlayerScores(state)).toEqual({
      winner: 'TEMPLE_OF_ARTEMIS_IN_EPHESUS',
      playerScores: [
